	...
	for region in "${REGIONS[@]}"; do
	    ...
	    # Remove RustFS data directory
	    if [ -d "${GIT_REPO_ROOT}/${RUSTFS_CONTAINER_NAME}" ]; then
		echo "🗑️  Removing RustFS data directory..."
		rm -rf "${GIT_REPO_ROOT}/${RUSTFS_CONTAINER_NAME}"
    fi
